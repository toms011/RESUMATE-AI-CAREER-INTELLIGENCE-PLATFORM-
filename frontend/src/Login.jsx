  ...
  return (
    <div className="min-h-screen flex bg-slate-50 overflow-hidden">
      ...
      <div className="lg-auth-left lg-hero">
        ...
        {/* Accent Lines */}
        <div className="lg-accent-line" style={{ top: '18%', background: 'linear-gradient(90deg, transparent, #6366f1, transparent)', animationDelay: '0s' }} />
        <div className="lg-accent-line" style={{ top: '45%', background: 'linear-gradient(90deg, transparent, #06b6d4, transparent)', animationDelay: '-1.5s' }} />
        <div className="lg-accent-line" style={{ top: '72%', background: 'linear-gradient(90deg, transparent, #8b5cf6, transparent)', animationDelay: '-3s' }} />
        ...
        <div className="relative z-10 text-center px-10 flex flex-col items-center">
          ...
          {/* Subtitle */}
          <p className="lg-slide-up lg-delay-3 text-blue-200/80 text-lg max-w-sm mx-auto leading-relaxed mb-10">
          ...
          <div className="flex flex-col gap-3 w-full max-w-xs">
            <div className="lg-badge" style={{ animationDelay: '.6s' }}>
              ...
              AI Career Intelligence & Analytics
            </div>
            <div className="lg-badge" style={{ animationDelay: '.8s' }}>
              <span className="lg-badge-icon" style={{ background: 'rgba(6,182,212,.2)' }}>
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#67e8f9" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  <rect x="2" y="3" width="20" height="14" rx="2"/><path d="M8 21h8"/><path d="M12 17v4"/><path d="M7 8h5"/><path d="M7 11h3"/>
                </svg>
              </span>
              Smart Resume Compare & ATS Scoring
            </div>
          ...
          {[...Array(6)].map((_, i) => (
            <div
              ...
              style={{
                ...
                left: 15 + i * 14 + '%',
                bottom: 5 + (i * 7) % 30 + '%',
                background: ['#6366f1','#3b82f6','#06b6d4','#8b5cf6','#6366f1','#3b82f6'][i],
